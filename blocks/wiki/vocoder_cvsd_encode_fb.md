<!-- block: vocoder_cvsd_encode_fb -->
<!-- title: CVSD Encoder -->
<!-- source: https://wiki.gnuradio.org/index.php/CVSD_Encoder -->
<!-- license: CC BY-SA 4.0 — https://wiki.gnuradio.org -->
<!-- fetched: 2026-09-12 -->

This is a wrapper for the CVSD encoder that performs interpolation and filtering necessary to work with the vocoding.
It converts an incoming float (+-1) to a short, scales it (to 32000, slightly below the maximum value), interpolates it, and then vocodes it.
